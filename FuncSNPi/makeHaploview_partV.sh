...
##ALL
	tabix -fh ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20100804/ALL.2of4intersection.20100804.genotypes.vcf.gz $region > ALL.$riskname.$ethnic.$region.vcf
...
##AFR
	tabix -fh ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20100804/supporting/AFR.2of4intersection_allele_freq.20100804.genotypes.vcf.gz $region > AFR.$riskname.$ethnic.$region.vcf
...
##EUR
	tabix -fh ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20100804/supporting/EUR.2of4intersection_allele_freq.20100804.genotypes.vcf.gz $region > EUR.$riskname.$ethnic.$region.vcf
...
##ASN
	tabix -fh ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20100804/supporting/ASN.2of4intersection_allele_freq.20100804.genotypes.vcf.gz $region > ASN.$riskname.$ethnic.$region.vcf

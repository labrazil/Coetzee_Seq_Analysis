...
\begin{figure}[ht!]
\begin{center}
\includegraphics{FunciSNP.0.99.0/plots/TFBS_Pol2_U87_R2vsDist_riskSNP.pdf}
...
\begin{figure}[ht!]
\begin{center}
\includegraphics{FunciSNP.0.99.0/plots/TFBS_Pol2_U87_R2summary_riskSNP.pdf}
...
toLatex(sessionInfo())                                                           
@ 
Our recent paper describing FunciSNP can be found in the Journal Nucleic Acids

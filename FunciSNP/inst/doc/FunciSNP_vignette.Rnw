...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author{Simon G. Coetzee$^\dagger$, $^\ddagger$\footnote{scoetzee NEAR gmail POINT com},
    Suhn K. Rhie$^\ddagger$, Benjamin P. Berman$^\ddagger$,\\Gerhard A.
        Coetzee$^\ddagger$ and Houtan Noushmehr$^\dagger$, $^\ddagger$\footnote{houtan NEAR
            usp POINT br}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
%%% Affiliation %%%
\begin{center}
$^\dagger$Faculdade de Medicina de Ribeir$\tilde{a}$o Preto\\Departmento de
...
\begin{figure}[ht!]
\begin{center}
\includegraphics{FunciSNP.0.2.0/plots/TFBS_Pol2_U87_R2vsDist_riskSNP.pdf}
...
\begin{figure}[ht!]
\begin{center}
\includegraphics{FunciSNP.0.2.0/plots/TFBS_Pol2_U87_R2summary_riskSNP.pdf}
...
See our recent paper about FunciSNP, published in Nucleic Acids Research (doi:
10.1093/nar/GKS542) in 2012.
\end{document}
